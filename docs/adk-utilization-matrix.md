...
|---|---|---|---|---|---|
| ADK-GAP-001 | Voice session wiring | Session audio path not fully bridged to runtime | Use `adk-realtime` session callbacks and runner context propagation | TBD | M1 |
